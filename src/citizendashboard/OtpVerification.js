        ...
        !isOtpSent ? (
          <div className="security-form">
            ...
            <input
              ...
              required
            />
            <button onClick={sendOtp} className="security-button">Send Verification OTP</button>
          </div>
        ) : (
          <div className="security-form">
            ...
            <input
              ...
              required
            />
            <button onClick={verifyOtp} className="security-button">Verify &amp; Continue</button>
          </div>
        )
      )}
    </div>
